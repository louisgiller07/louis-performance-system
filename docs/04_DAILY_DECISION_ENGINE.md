...
- **V0.3_002 — Domain Coaching Enrichment** : architecture verrouillée le 2026-08-28 (voir `docs/06_ARCHITECTURE.md` §V0.3_002 et `docs/11_DECISION_LOG.md`) ; décomposition V0.3_002A (architecture, CLOSED) → V0.3_002B (Technique DH, CLOSED LOCALLY 2026-08-28) → V0.3_002C (Mental, CLOSED LOCALLY 2026-08-29) → V0.3_002D (Nutrition, CLOSED LOCALLY 2026-08-30) → V0.3_002E (intégration/régressions, NOT STARTED — next) → V0.3_002F (rollout remote/clôture). `dh_or_technical`/`mental`/`nutrition` sont désormais tous actifs.
