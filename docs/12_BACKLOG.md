...
- [ ] Push `CLAUDE.md`
- [ ] Push `docs/00_PROJECT_STATUS.md`
- [ ] Push `docs/01_PRODUCT_REQUIREMENTS.md`
- [ ] Push `docs/02_ATHLETE_PROFILE.md`
- [ ] Push `docs/03_COACHING_MODEL.md`
- [ ] Push `docs/04_DAILY_DECISION_ENGINE.md`
- [ ] Push `docs/05_DATA_MODEL.md`
- [ ] Push `docs/06_ARCHITECTURE.md`
- [ ] Push `docs/07_GLOSSARY.md`
- [ ] Push `docs/08_CONVENTIONS.md`
- [ ] Push `docs/10_TEST_PLAN.md`
- [ ] Push `docs/11_DECISION_LOG.md`
- [ ] Push `docs/12_BACKLOG.md`

### Head Coach Engine vertical slice

- [ ] Initialiser `head-coach-engine/` avec Node LTS + TypeScript strict + Vitest
...
- [ ] Types de base : `EngineContext`, `AthleteDimensions`, `ContextState`, `DailyPlan`, `TrainingIntervention`, `DbSessionType`
...
- [ ] Couche A — SAFETY rules (5 règles canoniques)
...
- [ ] Tests d'intégration canoniques (T1-T10 de `10_TEST_PLAN.md`)
- [ ] CLI `npm run run:example <scenario>`
- [ ] `npm run build` sans erreur

### Validation M1

- [ ] Tous les tests passent (déterministes, aucune sortie alternative)
...
- [ ] Concept `ActiveExperiment` implémenté
- [ ] Support de l'experiment `sleep-liquids-cutoff-2026-08`
- [ ] Test T9.1 et T9.2 passent

### Connexion Supabase read-only (M2)

- [ ] Adapter Supabase → EngineContext
- [ ] Lecture des tables : `athletes`, `daily_checkins`, `training_blocks`, `planned_sessions`, `race_calendar`, `completed_sessions`, `weekly_availability`, `athlete_baselines`
