...
**Statut** : implémentation locale validée, toutes les preuves empiriques (pures + DB-dépendantes, migrations locales uniquement) au vert, **non déployée remote, aucune clôture** ; revue de déploiement remote et clôture M5_006B restent des étapes distinctes, non entamées ; M5 dans son ensemble reste en cours
