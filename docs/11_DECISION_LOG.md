...
**Régressions confirmées** : `longitudinal-engine` suite complète = **461/461** (409 + 52), reconfirmé sur 2 exécutions consécutives fraîches, build = PASS. M5_004 calculateur = **59/59**, résolveur partagé = **15/15**, M5_005 détecteur = **31/31** (inchangés, inclus dans les 409). M1/M2 = **226/226**, edge = **9/9**, M3 HTTP = **26/26**, completed-session unit = **73/73**, completed-session HTTP = **70/70**, web = **242/242**, web build = PASS.
